extern enum KYBRD_ENCODER_IO { //ENCODER PORT

	KYBRD_ENC_INPUT_BUF	=	0x60,
	KYBRD_ENC_CMD_REG	=	0x60
};

extern enum KYBRD_ENC_CMDS {	//ENCODER COMMANDS
...
extern enum KYBRD_CTRL_IO {  //PORT

	KYBRD_CTRL_STATS_REG=	0x64,
	KYBRD_CTRL_CMD_REG	=	0x64
};

extern enum KYBRD_CTRL_STATS_MASK {	//PORT STATUS (read this byte and do stuff)
...
extern enum KYBRD_CTRL_CMDS {			//CONTROLLER COMMANDS
...
extern enum KEYCODE {  //In this project we CAN'T PRINT ALL OF THIS. Can you fix it? :)
...
extern int _kkybrd_scancode_std [] = {
...
extern const int INVALID_SCANCODE = 0;